...
/**
 * Shared test utility for JWKS and JWT token generation
 * Used across all services for integration testing with OAuth2 Resource Server
 */
public class JwksTestUtil {
    public static class Keys {
        ...
        public Keys(String kid, RSAPrivateKey priv, RSAPublicKey pub) {
            this.kid = kid;
            this.priv = priv;
            this.pub = pub;
        }
